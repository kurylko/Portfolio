...
const Footer = () => {
    ...
    return (
        <div className='footer'>
            ...
            <p>Feel free to reach me on <a className='message-links' href="https://www.linkedin.com/in/valeria-kurylko/">LinkedIn</a> or send
                an <a className='message-links' href="mailto:valeriia.kurylko22@gmail.com">e-mail</a>.</p>
